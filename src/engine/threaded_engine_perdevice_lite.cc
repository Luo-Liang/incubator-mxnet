 ...
 */
class ThreadedEnginePerDeviceLite : public ThreadedEngine {
 public:
  ...
  void PushToExecute(OprBlock *opr_block, bool pusher_thread) override {
    ...
    //std::cout<<"currently looking at " << opr_block->opr->opr_name << std::endl;
        if (opr_block->profiling && 
            ...
            strcmp(opr_block->opr->opr_name,"KVStoreDistDefaultPush") &&
            strcmp(opr_block->opr->opr_name,"KVStoreDistDefaultPull") && 
...
Engine *CreateThreadedEnginePerDeviceLite() {
  return new ThreadedEnginePerDeviceLite();
}
}  // namespace engine
}  // namespace mxnet
